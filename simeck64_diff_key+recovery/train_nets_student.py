...
wdir = './freshly_trained_student_nets/16-round-ND/'
diff = (0x0, 0x400)
bits = [9, 8, 7, 6, 5, 4, 3, 2, 1, 0]
teacher = './freshly_trained_nets/16-round-ND/best16depth5(0x0,400).h5'
...
def make_resnet(num_blocks=2, num_filters_1=32, num_filters_2=32, num_filters_3=32, num_outputs=1, d0=512,d1=64, d2=64, word_size=32, ks=3,depth=5, reg_param=0.0001, final_activation='sigmoid',s_groups = 1,ks_value_1=1,ks_value_2=3,ks_value_3=3,dropout_value=0.8,se_ratio=16):
