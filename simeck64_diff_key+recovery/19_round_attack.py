...
if __name__ == '__main__':
    ...
    nd1 = './freshly_trained_student_nets/16-round-ND_simple/best16depth5(0x0,400)_student.h5'
    nd2 = './freshly_trained_student_nets/16-round-ND_simple/best16depth5(0x0,200000)_student.h5'
    nd3 = './freshly_trained_student_nets/16-round-ND_simple/best16depth5(0x0,1)_student.h5'


    selected_bits_1 = [9, 8, 7, 6, 5, 4, 3, 2, 1, 0]

    selected_bits_2 = [20, 19, 18, 17, 16, 15, 14, 13, 12, 11, 10]

    selected_bits_3 = [31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21]
    ...
    attack_with_dual_NDs(t=100, nr=19, diffs=(diff_1, diff_2, diff_3), NBs=(NB_1, NB_2, NB_3), nds=(nd1, nd2, nd3),
