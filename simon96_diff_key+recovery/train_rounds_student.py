...
if __name__=='__main__':
    ...
    parser.add_argument("--s_groups", type=int, default=4)   #8降为1
    parser.add_argument("--epochs", type=int, default=2)
    parser.add_argument("--num_rounds", type=int, default=14)
    ...
    parser.add_argument("--d1", type=int, default=96)   #分组长度
    ...
    parser.add_argument("--num_filters_1", type=int, default=48)    #分组的一半
    parser.add_argument("--num_filters_2", type=int, default=48)     #分组的一半
    parser.add_argument("--num_filters_3", type=int, default=48)     #分组的一半
