...
diff = (0x0, 0x1000)
wdir = './freshly_trained_nets/14-round-ND/'
...
def train_distinguisher(num_epochs, num_rounds=7, diff=diff, depth=1, filename="default", s_groups=1, bs=5000, lr_choice="14", d0=512, d1=48, d2=48, ks_value_1=1, ks_value_2=3, ks_value_3=3, machine_name='vgc', dropout_value=0.8, num_filters_1=24, num_filters_2=24, num_filters_3=24, reg_param=10**-4,high_lr=0.002,low_lr=0.0001,lr_epoch=10,se_ratio=16):
    print(diff)
    ...
    X, Y = sp.make_train_data(10**7*2, num_rounds, diff=diff, s_groups=s_groups)
    X_eval, Y_eval = sp.make_train_data(10**6*2, num_rounds, diff=diff, s_groups=s_groups)
