import train_nets_teacher as tn
...
if __name__=='__main__':
    ...
    parser.add_argument("--batch_size", type=int, default=5000)   #30000降为5000
    parser.add_argument("--s_groups", type=int, default=3)   #8降为1
    parser.add_argument("--epochs", type=int, default=2)
    parser.add_argument("--num_rounds", type=int, default=18)
    ...
    parser.add_argument("--d0", type=int, default=512)   #128升为512
    parser.add_argument("--d1", type=int, default=128)   #分组长度
    ...
    parser.add_argument("--num_filters_1", type=int, default=64)    #分组的一半
    parser.add_argument("--num_filters_2", type=int, default=64)     #分组的一半
    parser.add_argument("--num_filters_3", type=int, default=64)     #分组的一半
    ...
    parser.add_argument("--lr_epoch", type=int, default=10)   #30降为10
